...
petsUpForAdoption.add("3.Nemo The Fish");
    ...
    return   petsUpForAdoption.get(0) + " " + a.petHunger() + " " + a.petBordom() + " " +  a.petThirst() + " " +petsUpForAdoption.get(1) + " " + a.petHunger() + " " + a.petBordom() + " " +  a.petThirst() + " " + petsUpForAdoption.get(2) + " " + a.petHunger() + " " + a.petBordom() + " " +  a.petThirst();
    ...
    public String admitPetIntoShelter(){
        ...
        return " Please put in a valid input";
    }
}
